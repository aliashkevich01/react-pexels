...
const Header = (props: {className?:string}) => {
  ...
  return (
    <header className={`${props.className} ${classes.header}`}>
      <a href='/' className={classes.header_title}>Pexels</a>
        <SearchBar />
        <section>
          <button className={classes.hamburger} onClick={() => {
            setIsNavExpanded(!isNavExpanded);
          }}>
            <svg
         ...
         <ul className={isNavExpanded ? classes.header_list_is_open : classes.header_list}>
            <li className={classes.header_item}>
              <Link to="/" className={classes.category_link} onClick={() => {
            ...
            <li className={classes.header_item}>
              <Link to="/categories" className={classes.category_link} onClick={() => {
