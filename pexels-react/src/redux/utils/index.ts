...
export const createRequestString = (query: string, page: number, orienation: string, size: string, color: string) => {
  ...
  for(let key in queryParams) {
    if(queryParams[key as keyof QueryParamsInterface] && queryParams[key as keyof QueryParamsInterface] !== 'any'){
